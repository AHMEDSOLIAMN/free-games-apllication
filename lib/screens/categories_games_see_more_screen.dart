...
class CategoriesGamesSeeMoreScreen extends StatelessWidget {
  final categories;
  final title;

  const CategoriesGamesSeeMoreScreen({Key? key, this.title, this.categories})
      : super(key: key);
    ...
    return Consumer<ApplicationProvider>(
      builder: (context, controller, child) {
        return Scaffold(
          ...
          body: FutureBuilder(
            future: controller.getGamesByCategoriesData(categories: categories),
